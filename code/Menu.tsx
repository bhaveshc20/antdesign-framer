...
export class Menu extends React.Component<Props> {
    ...
    static propertyControls: PropertyControls = {
        inlineIndent: {
            type: ControlType.Number, title: "Inline Indent"
        },
        mode: {
        ...
        multiple: {
            type: ControlType.Boolean, title: "Multiple"
        },
        theme: {
            type: ControlType.Enum,
            title: "Theme",
        ...
        selectable: {
            type: ControlType.Boolean, title: "Selectable"
        },
        disabled: {
            type: ControlType.Boolean, title: "Disabled"
        },
        options: {
    ...
    render() {
        const {inlineIndent,mode, multiple, theme, selectable, disabled, options, ...rest} = this.props
        const ComponentProps = {
            inlineIndent, mode, multiple, theme, selectable, disabled, options
        }
        return (
